...
{
    public class EnvironmentObjectPlacement : MonoBehaviour
    {
        ...
        [SerializeField] private OVRInput.RawButton _grabButton = OVRInput.RawButton.RHandTrigger;
        [SerializeField] private OVRInput.RawButton _snapButton = OVRInput.RawButton.RIndexTrigger;
